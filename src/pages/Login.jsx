...
export default function Login() {
  ...
  return (
    <div className="auth-container min-h-[100dvh] flex flex-col md:flex-row bg-[#F3F4F6] text-[#111827]">
      ...
      <div className="w-full md:w-1/2 h-[400px] md:h-auto bg-gradient-to-br from-[#1D2A0E] to-[#6F8E2E] relative overflow-hidden flex items-center justify-center">
        ...
        <div className="w-full max-w-[448px] flex flex-col space-y-8">
          ...
          <div className="space-y-[32px]">
            ...
            <div className="relative group">
              ...
              />
              <div className="absolute bottom-0 left-0 h-[2px] bg-[#6F8E2E] w-0 transition-all duration-300 ease-out peer-focus:w-full"></div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button className="text-[14px] text-slate-500 hover:text-[#6F8E2E] font-medium transition-colors">
                Need help?
              </button>
            </div>
            ...
            <button 
              ...
              className={`w-full py-4 text-[16px] font-semibold flex items-center justify-center gap-2 rounded-xl transition-all duration-150
                ${username.trim().length > 2 
                  ? 'bg-[#6F8E2E] text-[#FFFFFF] shadow-lg shadow-[#6F8E2E]/20 hover:bg-[#2C3E17] active:scale-[0.98]' 
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 flex justify-center">
            <p className="text-[16px] text-slate-500">
              New here? <button className="font-bold text-[#6F8E2E] hover:underline decoration-2 underline-offset-4 ml-1">Sign Up</button>
            </p>
          </div>

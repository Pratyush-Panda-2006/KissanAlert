...
export default function Login() {
  ...
  return (
    <div className="auth-container min-h-[100dvh] flex flex-col md:flex-row bg-[#F3F4F6] text-[#111827]">
      ...
      <div className="w-full md:w-1/2 h-[400px] md:h-auto bg-gradient-to-br from-[#854D0E] to-[#A16207] relative overflow-hidden flex items-center justify-center">
        <div className="relative w-full h-full max-w-lg mx-auto flex items-center justify-center scale-75 sm:scale-100">
          
          {/* Water Droplet Shape */}
          <div className="absolute animate-float-shape w-[128px] h-[160px] rounded-[50%_50%_50%_50%/60%_60%_40%_40%] bg-[#EAB308]/40 shadow-2xl -ml-40 -mt-20 flex items-center justify-center backdrop-blur-sm border border-white/10">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="font-display text-white text-3xl uppercase tracking-wide">Kissan<span className="text-[#FDE047]">Alert</span></p>
        ...
        <div className="w-full max-w-[448px] flex flex-col space-y-8">
          ...
          <div className="space-y-[32px]">
            ...
            <div className="relative group">
              ...
              />
              <div className="absolute bottom-0 left-0 h-[2px] bg-[#854D0E] w-0 transition-all duration-300 ease-out peer-focus:w-full"></div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-3 cursor-pointer group">
                <div className="relative w-[20px] h-[20px]">
                  ...
                  <div className={`absolute inset-0 border-2 rounded-[6px] transition-all duration-200 flex items-center justify-center
                    ${rememberMe ? 'bg-[#854D0E] border-[#854D0E]' : 'border-slate-200 bg-transparent group-hover:border-slate-400'}`}>
              ...
              <button className="text-[14px] text-slate-500 hover:text-[#854D0E] font-medium transition-colors">
                Need help?
              </button>
            </div>
            ...
            <button 
              ...
              className={`w-full py-4 text-[16px] font-semibold flex items-center justify-center gap-2 rounded-xl transition-all duration-150
                ${username.trim().length > 2 
                  ? 'bg-[#854D0E] text-[#FFFFFF] shadow-lg shadow-[#854D0E]/20 hover:bg-[#A16207] active:scale-[0.98]' 
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 flex justify-center">
            <p className="text-[16px] text-slate-500">
              New here? <button className="font-bold text-[#854D0E] hover:underline decoration-2 underline-offset-4 ml-1">Sign Up</button>
            </p>
          </div>
